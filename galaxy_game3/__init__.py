...
class Constants(BaseConstants):
    name_in_url = 'planet_game_galaxy3'
    ...
    for planet in range(1, 366): #for each planet
        ...
        #    current_planet_center = np.random.randint(3, 7)*10 
        # else:
        #     current_planet_center = np.random.randint(4, 10)*10 
    ...
    def vars_for_template(player): 
        if player.round_number == 1:
            ...
            return {
                ...
                'image'    :  "".join(['level3/', str(number_of_exploratory_choices), '.jpg']) ,
...
class Combined_results(Page):
    ...
    def vars_for_template(player: Player):
        ...
        return {
            ...
            'planet_number': number_of_exploratory_choices,
            'gameover': 47 + number_of_exploratory_choices - 1
        }
class Discount(Page):
    @staticmethod
    def is_displayed(player: Player):
